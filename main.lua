...
local function CreateESP(player)
    ...
    local function OnCharacterAdded(character)
        ...
        -- BillboardGui avec taille réduite pour un meilleur centrage
...
TweenService:Create(overlay, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 0.5}):Play()
...
glow.BackgroundColor3 = Color3.new(0.15, 0.15, 0.15)
...
icon.Position = UDim2.new(0.5, -20, 0, 20)
icon.BackgroundTransparency = 1
icon.Image = "rbxassetid://7072719338"
icon.ImageColor3 = Color3.new(0.8, 0.8, 0.8)
icon.ZIndex = 3

local titleLabel = Instance.new("TextLabel")
titleLabel.Parent = frame
titleLabel.Size = UDim2.new(1, -40, 0, 30)
titleLabel.Position = UDim2.new(0, 20, 0, 70)
...
subtitleLabel.Text = "Pas encore ajouté"
...
closeButton.Position = UDim2.new(0.5, -60, 0, 130)
...
buttonGradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.new(0.4, 0.4, 0.4)),
...
closeButton.MouseEnter:Connect(function()
    TweenService:Create(closeButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        ...
        Position = UDim2.new(0.5, -62, 0, 129)
    }):Play()
end)
...
closeButton.MouseLeave:Connect(function()
    TweenService:Create(closeButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        ...
        Position = UDim2.new(0.5, -60, 0, 130)
    }):Play()
end)

local function closeUI()
    blur.Size = 0
    TweenService:Create(overlay, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundTransparency = 1}):Play()
...
TweenService:Create(blur, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = 8}):Play()
...
createToggle("Enable Walk Speed", false, function(enabled)
...
createButton("Respawn", function()
    ...
    notify("Me", "Respawning...", Color3.fromRGB(255, 165, 0))
end, MeContent)
...
do
    ...
    ConfigListFrame.Size = UDim2.new(1, 0, 1, -130)
    ...
    local UnloadConfigBtn = Instance.new("TextButton")
    UnloadConfigBtn.Size = UDim2.new(1, 0, 0, 46)
    UnloadConfigBtn.BackgroundColor3 = Color3.fromRGB(35, 15, 15)
    UnloadConfigBtn.BorderSizePixel = 0
    UnloadConfigBtn.Text = "UNLOAD NEBULA"
    UnloadConfigBtn.TextColor3 = Color3.fromRGB(255, 90, 90)
    UnloadConfigBtn.Font = Enum.Font.GothamBold
    UnloadConfigBtn.TextSize = 14
    UnloadConfigBtn.Parent = ConfigContent

    local UnloadConfigCorner = Instance.new("UICorner")
    UnloadConfigCorner.CornerRadius = UDim.new(0, 8)
    UnloadConfigCorner.Parent = UnloadConfigBtn

    UnloadConfigBtn.MouseButton1Click:Connect(unloadNebula)
